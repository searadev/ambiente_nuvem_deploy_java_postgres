...
create table tb_message (id bigserial not null, full_name varchar(255), title varchar(255),text text, date date, created_at TIMESTAMP WITHOUT TIME ZONE, updated_at TIMESTAMP WITHOUT TIME ZONE, medium_id int8 not null, user_id int8 not null, status boolean not null, primary key (id));
create table tb_psychography (id bigserial not null, full_name varchar(255),title varchar(255), text text, date date, created_at TIMESTAMP WITHOUT TIME ZONE, updated_at TIMESTAMP WITHOUT TIME ZONE, medium_id int8 not null, user_id int8 not null, status boolean not null, primary key (id));
